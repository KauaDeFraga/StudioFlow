...
export default function ScheduleGridExample() {
  const mockClasses = [
    ...
    { id: "7", modality: "Yoga Flow", instructor: "Ana P.", time: "10:00", day: 3, enrolled: 20, capacity: 25 },
    { id: "8", modality: "HIIT", instructor: "João S.", time: "18:00", day: 4, enrolled: 22, capacity: 25 },
  ];
